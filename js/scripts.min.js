...
$(".textarea-cell").click(function(){$(this).addClass("editable"),$(".textarea-cell").not(this).removeClass("editable")}),$(".textarea-cell").blur(function(){$innerText=$(this).prop("innerText"),$(".textarea-cell div").remove(),$(this).text($innerText)}),$(function(){$(document).on("click",function(e){!1===$(e.target).is(".textarea-cell")&&$(".textarea-cell").removeClass("editable")})}),$(".selectpicker").selectpicker(),$("#filter-link").on("click",function(e){$(".dropdown-menu-filter").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-filter").is(e.target)||$("#filter-link").is(e.target)||$("#filter-link>i").is(e.target)||0!==$(".dropdown-menu-filter").has(e.target).length||0!==$(".dropdown-menu-filter.show").has(e.target).length||$(".dropdown-menu-filter").removeClass("show")}),$("#hide-link").on("click",function(e){$(".dropdown-menu-hide").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-hide").is(e.target)||$("#hide-link").is(e.target)||$("#hide-link>i").is(e.target)||0!==$(".dropdown-menu-hide").has(e.target).length||0!==$(".dropdown-menu-hide.show").has(e.target).length||$(".dropdown-menu-hide").removeClass("show")}),$("#view-link").on("click",function(e){$(".dropdown-menu-view").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-view").is(e.target)||$("#view-link").is(e.target)||$("#view-link>i").is(e.target)||$("#view-link>span").is(e.target)||0!==$(".dropdown-menu-view").has(e.target).length||0!==$(".dropdown-menu-view.show").has(e.target).length||$(".dropdown-menu-view").removeClass("show")}),$("#search-link").on("click",function(e){$(".dropdown-menu-search").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-search").is(e.target)||$("#search-link").is(e.target)||$("#search-link>i").is(e.target)||0!==$(".dropdown-menu-search").has(e.target).length||0!==$(".dropdown-menu-search.show").has(e.target).length||$(".dropdown-menu-search").removeClass("show")}),$("#context-tab-link").on("click",function(e){$(".dropdown-menu-subtab").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-subtab").is(e.target)||$("#context-tab-link").is(e.target)||0!==$(".dropdown-menu-subtab").has(e.target).length||0!==$(".dropdown-menu-subtab.show").has(e.target).length||$(".dropdown-menu-subtab").removeClass("show")}),$(document).ready(function(){$("#rename-table-btn").click(function(){$("#first-tab-name").hide(),$("#first-tab-input").show(),$("#first-tab-input").select(),$(".dropdown-menu-subtab").removeClass("show")}),$("#first-tab-input").blur(function(){""==$.trim(this.value)?this.value=this.defaultValue?this.defaultValue:"":$("#first-tab-name").html(this.value),$("#first-tab-input").hide(),$("#first-tab-name").show()}),$("#first-tab-input").keypress(function(e){"13"==e.keyCode&&(""==$.trim(this.value)?this.value=this.defaultValue?this.defaultValue:"":$("#first-tab-name").html(this.value),$("#first-tab-input").hide(),$("#first-tab-name").show())})}),$(function(){$.contextMenu({selector:"td",className:"context-menu-td",items:{"Insert record above":{name:"Insert record above",icon:"fas fa-long-arrow-alt-up"},"Insert record below":{name:"Insert record below",icon:"fas fa-long-arrow-alt-down"},"Duplicate record":{name:"Duplicate record",icon:"fas fa-copy"},"Expand record":{name:"Expand record",icon:"fas fa-expand"},"Copy record URL":{name:"Copy record URL",icon:"fas fa-clipboard-list"},"Send record...":{name:"Send record...",icon:"fas fa-envelope"},"Delete record":{name:"Delete record",icon:"fas fa-trash"}}}),$(".context-menu-one").on("click",function(e){console.log("clicked",this)})}),$(function(){$.contextMenu({selector:"th",className:"context-menu-th",items:{"Customize field type":{name:"Customize field type",icon:"fas fa-cogs"},"Rename field":{name:"Rename field",icon:"fas fa-pencil-alt"},"Edit description":{name:"Edit description",icon:"fas fa-info-circle"},"Duplicate field":{name:"Duplicate field",icon:"fas fa-copy"},"Insert left":{name:"Insert left",icon:"fas fa-long-arrow-alt-left"},"Insert right":{name:"Insert right",icon:"fas fa-long-arrow-alt-right"},"Sort A - Z":{name:"Sort A - Z",icon:"fas fa-sort-alpha-down"},"Sort Z - A":{name:"Sort Z - A",icon:"fas fa-sort-alpha-up"},"Add filter":{name:"Add filter",icon:"fas fa-align-center"},"Group by this field":{name:"Group by this field",icon:"fas fa-clipboard-list"},"Hide field":{name:"Hide field",icon:"fas fa-eye-slash"},"Delete field":{name:"Delete field",icon:"fas fa-trash"}}}),$(".context-menu-one").on("click",function(e){console.log("clicked",this)})}),$(".sortable").sortable(),$(document).ready(function(){$("#field1").change(function(){this.checked?$(".field1-col").show("fade"):$(".field1-col").hide("fade")})}),$(document).ready(function(){$("#field2").change(function(){this.checked?$(".field2-col").show("fade"):$(".field2-col").hide("fade")})}),$(document).ready(function(){$("#field3").change(function(){this.checked?$(".field3-col").show("fade"):$(".field3-col").hide("fade")})}),$(document).ready(function(){$("#field4").change(function(){this.checked?$(".field4-col").show("fade"):$(".field4-col").hide("fade")})}),$(document).ready(function(){$("#field5").change(function(){this.checked?$(".field5-col").show("fade"):$(".field5-col").hide("fade")})}),$(document).ready(function(){$("#field6").change(function(){this.checked?$(".field6-col").show("fade"):$(".field6-col").hide("fade")})}),$(document).ready(function(){$("#field7").change(function(){this.checked?$(".field7-col").show("fade"):$(".field7-col").hide("fade")})}),$(document).ready(function(){$("#field8").change(function(){this.checked?$(".field8-col").show("fade"):$(".field8-col").hide("fade")})}),$(document).ready(function(){$("#field9").change(function(){this.checked?$(".field9-col").show("fade"):$(".field9-col").hide("fade")})}),$(".menuhide-hideall-btn").on("click",function(){$(".fields-to-hide_check").prop("checked",!1),$(".field1-col").hide("fade"),$(".field2-col").hide("fade"),$(".field3-col").hide("fade"),$(".field4-col").hide("fade"),$(".field5-col").hide("fade"),$(".field6-col").hide("fade"),$(".field7-col").hide("fade"),$(".field8-col").hide("fade"),$(".field9-col").hide("fade")}),$(".menuhide-showall-btn").on("click",function(){$(".fields-to-hide_check").prop("checked",!0),$(".field1-col").show("fade"),$(".field2-col").show("fade"),$(".field3-col").show("fade"),$(".field4-col").show("fade"),$(".field5-col").show("fade"),$(".field6-col").show("fade"),$(".field7-col").show("fade"),$(".field8-col").show("fade"),$(".field9-col").show("fade")});